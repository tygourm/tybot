...
get_logger("alembic").setLevel(logging.DEBUG if settings.dev else logging.INFO)
get_logger("sqlalchemy").setLevel(logging.DEBUG if settings.dev else logging.INFO)
